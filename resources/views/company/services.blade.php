						...
						<div class="row align-items-center">
							<div class="col-xl-6 col-md-4">
								<div class="carousel-thumb">
									<img src="{{Voyager::image($sv->image1)}}" alt="" class="img-fluid">
								</div>
							</div>
							<div class="col-xl-6 col-md-4">
								<div class="carousel-thumb">
									<img src="{{Voyager::image($sv->image2)}}" alt="" class="img-fluid">
								</div>
							</div>
							<div class="col-xl-6 col-md-4">
								<div class="carousel-thumb">
									<img src="{{Voyager::image($sv->image3)}}" alt="" class="img-fluid">
								</div>
							</div>
